...
import Bandwidth from "../component/bandwidthtable.js";




class Bandwidthserver extends Component {
    constructor(props) {
        super(props);
        this.state = {
            isFetching: false,
    ...
    render() {
        ...
        return (<div style={((this.props.serverError === "") && (connection == null)) ?{
            display: "flex", justifyContent: "center", alignItems: "center", height:"92.5%", width:"100%", position: "absolute"}: {display: "flex",justifyContent: "space-between",alignItems: "center"}}>
                ...
                {connection != null && <>
                    <Bandwidth data={connection.bandwidth[0]} serverId={server}>
                    </Bandwidth>
...
export default connect(mapStateToProps, { connectToServer })(Bandwidthserver);
