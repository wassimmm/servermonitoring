...
import FirewallTable from "../component/firewalltable.js";




class FirewallServer extends Component {
    constructor(props) {
        super(props);
        this.state = {
            isFetching: false,
    ...
    render() {
        ...
        return (<div style={((this.props.serverError === "") && (connection == null)) ?{
            display: "flex", justifyContent: "center", alignItems: "center", height:"92.5%", width:"100%", position: "absolute"}: {display: "flex",justifyContent: "space-between",alignItems: "center"}}>
                ...
                {connection != null && <>
                    <FirewallTable data={connection.firewall[0]} serverId={server}>
                    </FirewallTable>
...
export default connect(mapStateToProps, { connectToServer })(FirewallServer);
